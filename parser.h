...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOK_LPAREN = 286,              /* TOK_LPAREN  */
    TOK_RPAREN = 287,              /* TOK_RPAREN  */
    TOK_SEMI = 288,                /* TOK_SEMI  */
